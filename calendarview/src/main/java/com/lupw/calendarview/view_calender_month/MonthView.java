...
public class MonthView extends View {
    ...
    private int itemRowCount = 2;         // 总共有多少行item
    private int itemColumnCount = 6;      // 一行有多少个item
    ...
    public MonthView(Context context, int pageIndex) {
        super(context);
        init(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mHeight = itemHeight * itemRowCount + DensityUtil.dp2px(context, 10);
        viewHeight = mHeight;
    ...
    private void setItemRect() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            rectList.add(new Rect(column * itemWidth, row * itemHeight + marginWeekTop,
                    (column + 1) * itemWidth, (row + 1) * itemHeight + marginWeekTop));
        }
    }
